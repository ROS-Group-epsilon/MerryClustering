...
MerryMotionplanner::MerryMotionplanner(ros::NodeHandle *nodehandle):nh_(*nodehandle) {
...
Eigen::Affine3d MerryMotionplanner::transformPostToEigenAffine3d(geometry_msgs::Pose pose) {
    Eigen::Affine3d affine;
    Eigen::Vector3d Oe;

    Oe(0) = pose.position.x;
    Oe(1) = pose.position.y;
    Oe(2) = pose.potition.z;
