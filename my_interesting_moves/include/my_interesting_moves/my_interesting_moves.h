...
/// This class provides several functions to move in designed ways, like salute, wave and sayhi.
///
...
class My_interesting_moves
{
public:
    My_interesting_moves(ros::NodeHandle* nodehandle); //"main" will need to instantiate a ROS nodehandle, then pass it to the constructor
    ...
    void move_to_origin(trajectory_msgs::JointTrajectory &des_trajectory);
